...
import com.smartindiahackathon2022.SAKHAM.English.verifyOTPActivity;
import com.smartindiahackathon2022.SAKHAM.R;

import java.util.concurrent.TimeUnit;

public class HindiVerifyOTPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hindi_verify_otpactivity);
        ...
        buttonverify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!inputcode1.getText().toString().trim().isEmpty()
                                ...
                                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        ...
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(HindiVerifyOTPActivity.this, "Enter the Correct otp", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                    }
                    ...
                    Toast.makeText(HindiVerifyOTPActivity.this, "Please enter the otp", Toast.LENGTH_SHORT).show();
                }
            }
        });
                ...
                PhoneAuthProvider.getInstance().verifyPhoneNumber(
                        ...
                        new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                ...
                                Toast.makeText(HindiVerifyOTPActivity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                            }
                            ...
                            public void onCodeSent(@NonNull String newVerification, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                ...
                                Toast.makeText(HindiVerifyOTPActivity.this, "OTP sent again", Toast.LENGTH_SHORT).show();
                            }
                        }
