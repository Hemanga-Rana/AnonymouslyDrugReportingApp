...
public class sendotpHindiActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sendotp_hindi);
...
//                         #2
                        ...
                        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                                ...
                                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                                    ...
                                    public void onVerificationFailed(@NonNull FirebaseException e) {
                                        progressBar.setVisibility(View.GONE);
                                        buttongetotp.setVisibility(View.VISIBLE);
                                        Toast.makeText(sendotpHindiActivity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                                    }
                                    ...
                                    public void onCodeSent(@NonNull String verficationid, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                        progressBar.setVisibility(View.GONE);
                                        buttongetotp.setVisibility(View.VISIBLE);
                                        Intent intent = new Intent(getApplicationContext(), HindiVerifyOTPActivity.class);
                        ...
                        Toast.makeText(sendotpHindiActivity.this,"Please enter correct number",Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(sendotpHindiActivity.this,"Enter Mobile number",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
