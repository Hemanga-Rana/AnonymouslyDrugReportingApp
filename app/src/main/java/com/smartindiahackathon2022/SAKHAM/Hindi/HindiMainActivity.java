...
import com.smartindiahackathon2022.SAKHAM.English.MainActivity;
...
public class HindiMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(HindiMainActivity.this, "Location can be added.", Toast.LENGTH_SHORT).show();
        ...
        imageView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), InfoHindiActivity.class);
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (imageUri != null){
                    ...
                    Toast.makeText(HindiMainActivity.this, "Your report send successfully", Toast.LENGTH_SHORT).show();

                    //Get all the values
                    String place = drugPlace.getEditText().getText().toString();
                    String report = drugReport.getEditText().getText().toString();
                    UserHelperHindiClass helperClass = new UserHelperHindiClass(place, report);
                    root.child(place).setValue(helperClass);
                    Intent intent = new Intent(getApplicationContext(), DeleteHindiActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(intent);
                }
                else{
//                    Toast.makeText(SignUp.this, "Please Select Image", Toast.LENGTH_SHORT).show();
                    Toast.makeText(HindiMainActivity.this, "Information Sent Successfully", Toast.LENGTH_SHORT).show();
    ...
    private void uploadToFirebase(Uri uri){
        ...
        fileRef.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        HindiModel model = new HindiModel(uri.toString());
                        String modelId = root.push().getKey();
                        root.child(modelId).setValue(model);
                        Toast.makeText(HindiMainActivity.this, "Uploaded Successfully", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(HindiMainActivity.this, "Uploading Failed !!", Toast.LENGTH_SHORT).show();
            }
        });
    }
